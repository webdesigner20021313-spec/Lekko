...
/**
 * PUT /api/purchases/:id/accept — клиент акцептит изменения дистра.
...
/**
 * PUT /api/purchases/:id/reject — клиент отказывается.
 * Все distributor_orders snapshot'а → status=13 rejected.
 */
