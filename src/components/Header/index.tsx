...
export function Header() {
  ...
  const { language, setLanguage, theme, setTheme, toggleMobileMenu, mobileMenuOpen } = useUIStore()
  ...
  return (
    <header className="shrink-0 border-b border-gray-200 bg-white dark:border-[#333333] dark:bg-[#111111]">
      ...
      <div className="flex h-14 items-center justify-between px-4 md:hidden">
        ...
        {/* Right — Lang + Bell + Burger */}
        <div className="flex items-center gap-1">

          {/* Language: one tap to switch */}
          <button
            onClick={() => setLanguage(language === 'ru' ? 'uz' : 'ru')}
            className="flex h-8 items-center rounded-lg border border-gray-200 px-2.5 text-xs font-semibold text-gray-600 transition-colors hover:border-gray-300 hover:bg-gray-50 dark:border-gray-700 dark:text-gray-300 dark:hover:bg-gray-800"
          >
            {langLabels[language]}
          </button>
          ...
          <div ref={mNotifRef} className="relative">
            ...
            {showNotifications && (
              <div className="absolute right-0 top-[calc(100%+8px)] z-50 w-[300px] rounded-xl border border-gray-200 bg-white shadow-lg dark:border-gray-700 dark:bg-[#111111]">
          ...
          {/* Portal: Burger / Standalone: Theme toggle */}
          {appMode.mode === 'portal' ? (
            <button
              ...
              className={cn(
                ...
                mobileMenuOpen
                  ? 'bg-gray-100 text-gray-900 dark:bg-[#222222] dark:text-white'
