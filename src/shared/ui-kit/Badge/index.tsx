...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border px-4 py-0.5 text-xs font-medium transition-colors",
  {
    variants: {
      variant: {
        default:
          "border-transparent bg-gray-900 text-white dark:bg-[#f1f1f1] dark:text-gray-900",
        secondary:
          "border-transparent bg-[#DBEAFE] text-[#1E40AF] dark:bg-[#1E3A8A]/40 dark:text-[#93C5FD]",
        outline:
          "border-gray-200 bg-white text-gray-700 dark:border-gray-700 dark:bg-[#222222] dark:text-gray-300",
        success:
